  ...
  <div class="app-container">
    ...
    <el-card>
      ...
      >
        <el-table-column type="selection" width="30" />
                <el-table-column prop="Plug_id" label="插件ID" sortable="custom" width="120" />
        <el-table-column prop="Sys_id" label="系统ID" sortable="custom" width="120" />
    ...
    >
      <el-form ref="editFrom" :model="editFrom" :rules="rules">
                <el-form-item label="插件ID" :label-width="formLabelWidth" prop="Plug_id">
          <el-input v-model="editFrom.Plug_id" placeholder="请输入插件ID" autocomplete="off" clearable />
        </el-form-item>
        <el-form-item label="系统ID" :label-width="formLabelWidth" prop="Sys_id">
          <el-input v-model="editFrom.Sys_id" placeholder="请输入系统ID" autocomplete="off" clearable />
        </el-form-item>
...
import { getPlug_sysrelationListWithPager, getPlug_sysrelationDetail,
  savePlug_sysrelation, setPlug_sysrelationEnable, deleteSoftPlug_sysrelation,
  deletePlug_sysrelation } from '@/api/plug_sysrelation/plug_sysrelation'
...
export default {
  ...
  methods: {
    ...
    loadTableData: function() {
      ...
      getPlug_sysrelationListWithPager(seachdata).then(res => {
    ...
    bindEditInfo: function() {
      getPlug_sysrelationDetail(this.currentId).then(res => {
               this.editFrom.Plug_id = res.ResData.Plug_id
    ...
    saveEditForm() {
      this.$refs['editFrom'].validate((valid) => {
        ...
        'DeleteUserId':this.editFrom.DeleteUserId,
          ...
          savePlug_sysrelation(data).then(res => {
            if (res.Success) {
              this.$message({
                message: '恭喜你，操作成功',
                type: 'success'
    ...
    setEnable: function(val) {
      if (this.currentSelected.length === 0) {
        ...
        setPlug_sysrelationEnable(data).then(res => {
          if (res.Success) {
            this.$message({
              message: '恭喜你，操作成功',
              type: 'success'
    ...
    deleteSoft: function(val) {
      if (this.currentSelected.length === 0) {
        ...
        deleteSoftPlug_sysrelation(data).then(res => {
          if (res.Success) {
            this.$message({
              message: '恭喜你，操作成功',
              type: 'success'
    ...
    deletePhysics: function() {
      if (this.currentSelected.length === 0) {
        ...
        deletePlug_sysrelation(data).then(res => {
          if (res.Success) {
            this.$message({
              message: '恭喜你，操作成功',
              type: 'success'
