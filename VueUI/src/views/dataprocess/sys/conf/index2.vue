            ...
            <div class="list-btn-container">
              <el-button-group>
                <el-button v-hasPermi="['Sys_conf_details/Add']"
                           ...
                           icon="el-icon-plus"
                           size="small"
                           @click="ShowEditOrViewDetailDialog()">新增</el-button>
                ...
                <el-button v-hasPermi="['Sys_conf_details/Enable']"
                           ...
                           icon="el-icon-video-pause"
                           size="small"
                           @click="setDetailEnable('0')">禁用</el-button>
                <el-button v-hasPermi="['Sys_conf_details/Enable']"
                           type="success"
                           icon="el-icon-video-play"
                           size="small"
                           @click="setDetailEnable('1')">启用</el-button>
                <el-button v-hasPermi="['Sys_conf_details/DeleteSoft']"
                           type="warning"
                           icon="el-icon-delete"
                           size="small"
                           @click="deleteDetailSoft('0')">软删除</el-button>
                <el-button v-hasPermi="['Sys_conf_details/Delete']"
                           type="danger"
                           icon="el-icon-delete"
                           size="small"
                           @click="deleteDetailPhysics()">删除</el-button>
