  ...
  <div class="app-container">
    ...
    <el-card>
      ...
      >
        ...
        <el-table-column prop="Rela_id" label="被关联ID" sortable="custom" width="120" />
        <el-table-column prop="Relatype" label="被关联类型" sortable="custom" width="120" />
    ...
    >
      <el-form ref="editFrom" :model="editFrom" :rules="rules">
        ...
        <el-form-item label="被关联ID" :label-width="formLabelWidth" prop="Rela_id">
          <el-input v-model="editFrom.Rela_id" placeholder="请输入被关联ID" autocomplete="off" clearable />
        </el-form-item>
        <el-form-item label="被关联类型" :label-width="formLabelWidth" prop="Relatype">
          <el-input v-model="editFrom.Relatype" placeholder="请输入被关联类型" autocomplete="off" clearable />
        </el-form-item>
...
import { getDs_relationListWithPager, getDs_relationDetail,
  saveDs_relation, setDs_relationEnable, deleteSoftDs_relation,
  deleteDs_relation } from '@/api/ds_relation/ds_relation'
...
export default {
  ...
  methods: {
    ...
    loadTableData: function() {
      ...
      getDs_relationListWithPager(seachdata).then(res => {
    ...
    bindEditInfo: function() {
      getDs_relationDetail(this.currentId).then(res => {
               this.editFrom.Ds_id = res.ResData.Ds_id
        this.editFrom.Rela_id = res.ResData.Rela_id
        this.editFrom.Relatype = res.ResData.Relatype
    ...
    saveEditForm() {
      this.$refs['editFrom'].validate((valid) => {
        ...
        'Rela_id':this.editFrom.Rela_id,
        'Relatype':this.editFrom.Relatype,
    ...
    setEnable: function(val) {
      if (this.currentSelected.length === 0) {
        ...
        setDs_relationEnable(data).then(res => {
          if (res.Success) {
            this.$message({
              message: '恭喜你，操作成功',
              type: 'success'
    ...
    deleteSoft: function(val) {
      if (this.currentSelected.length === 0) {
        ...
        deleteSoftDs_relation(data).then(res => {
          if (res.Success) {
            this.$message({
              message: '恭喜你，操作成功',
              type: 'success'
    ...
    deletePhysics: function() {
      if (this.currentSelected.length === 0) {
        ...
        deleteDs_relation(data).then(res => {
          if (res.Success) {
            this.$message({
              message: '恭喜你，操作成功',
              type: 'success'
