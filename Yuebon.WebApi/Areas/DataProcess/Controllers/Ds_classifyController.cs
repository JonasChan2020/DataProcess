...
namespace Yuebon.WebApi.Areas.DataProcess.Controllers
{
    ...
    public class Ds_classifyController : AreaApiController<Ds_classify, Ds_classifyOutputDto,Ds_classifyInputDto,IDs_classifyService,string>
    {
        ...
        [HttpPost("Insert")]
        [YuebonAuthorize("Add")]
        public override async Task<IActionResult> InsertAsync(Ds_classifyInputDto tinfo)
        {
            ...
            if (!string.IsNullOrEmpty(tinfo.Dtcode))
            {
                ...
                Ds_classify model = iService.GetWhere(where);
                if (model != null)
                {
            ...
            Ds_classify info = tinfo.MapTo<Ds_classify>();
            OnBeforeInsert(info);
        ...
        public override async Task<IActionResult> UpdateAsync(Ds_classifyInputDto tinfo, string id)
        {
            CommonResult result = new CommonResult();
            ...
            Ds_classify info = iService.Get(id);
