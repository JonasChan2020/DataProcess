  ...
  <div class="app-container">
    ...
    <el-card>
      ...
      >
        ...
        <el-table-column prop="Sysclassify" label="目标库分类" sortable="custom" width="120" />
    ...
    >
      <el-form ref="editFrom" :model="editFrom" :rules="rules">
        ...
        <el-form-item label="目标库分类" :label-width="formLabelWidth" prop="Sysclassify">
          <el-input v-model="editFrom.Sysclassify" placeholder="请输入目标库分类" autocomplete="off" clearable />
        </el-form-item>
...
import { getSd_sysdbListWithPager, getSd_sysdbDetail,
  ...
  deleteSd_sysdb } from '@/api/sd_sysdb/sd_sysdb'
