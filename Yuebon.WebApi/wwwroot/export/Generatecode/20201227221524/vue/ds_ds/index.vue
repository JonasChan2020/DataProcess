  ...
  <div class="app-container">
    ...
    <el-card>
      ...
      >
        ...
        <el-table-column prop="Dsdesc" label="数据源描述" sortable="custom" width="120" />
        <el-table-column prop="Dsclassify" label="数据源分类" sortable="custom" width="120" />
    ...
    >
      <el-form ref="editFrom" :model="editFrom" :rules="rules">
        ...
        <el-form-item label="数据源名称" :label-width="formLabelWidth" prop="Dsname">
          <el-input v-model="editFrom.Dsname" placeholder="请输入数据源名称" autocomplete="off" clearable />
        </el-form-item>
        <el-form-item label="数据源描述" :label-width="formLabelWidth" prop="Dsdesc">
          <el-input v-model="editFrom.Dsdesc" placeholder="请输入数据源描述" autocomplete="off" clearable />
        </el-form-item>
        <el-form-item label="数据源分类" :label-width="formLabelWidth" prop="Dsclassify">
          <el-input v-model="editFrom.Dsclassify" placeholder="请输入数据源分类" autocomplete="off" clearable />
        </el-form-item>
...
import { getDs_dsListWithPager, getDs_dsDetail,
  ...
  deleteDs_ds } from '@/api/ds_ds/ds_ds'
...
export default {
  ...
  methods: {
    ...
    loadTableData: function() {
      ...
      getDs_dsListWithPager(seachdata).then(res => {
    ...
    bindEditInfo: function() {
      getDs_dsDetail(this.currentId).then(res => {
        ...
        this.editFrom.Dsdesc = res.ResData.Dsdesc
        this.editFrom.Dsclassify = res.ResData.Dsclassify
    ...
    saveEditForm() {
      this.$refs['editFrom'].validate((valid) => {
        ...
        'Dsdesc':this.editFrom.Dsdesc,
        'Dsclassify':this.editFrom.Dsclassify,
