  ...
  <div class="app-container">
    ...
    <el-card>
      ...
      >
        <el-table-column type="selection" width="30" />
                <el-table-column prop="Dsconfig" label="数据源配置信息" sortable="custom" width="120" />
    ...
    >
      <el-form ref="editFrom" :model="editFrom" :rules="rules">
                <el-form-item label="数据源配置信息" :label-width="formLabelWidth" prop="Dsconfig">
          <el-input v-model="editFrom.Dsconfig" placeholder="请输入数据源配置信息" autocomplete="off" clearable />
        </el-form-item>
...
import { getDs_dsconfigListWithPager, getDs_dsconfigDetail,
  saveDs_dsconfig, setDs_dsconfigEnable, deleteSoftDs_dsconfig,
  deleteDs_dsconfig } from '@/api/ds_dsconfig/ds_dsconfig'
...
export default {
  ...
  methods: {
    ...
    loadTableData: function() {
      ...
      getDs_dsconfigListWithPager(seachdata).then(res => {
    ...
    bindEditInfo: function() {
      getDs_dsconfigDetail(this.currentId).then(res => {
    ...
    setEnable: function(val) {
      if (this.currentSelected.length === 0) {
        ...
        setDs_dsconfigEnable(data).then(res => {
          if (res.Success) {
            this.$message({
              message: '恭喜你，操作成功',
              type: 'success'
    ...
    deleteSoft: function(val) {
      if (this.currentSelected.length === 0) {
        ...
        deleteSoftDs_dsconfig(data).then(res => {
          if (res.Success) {
            this.$message({
              message: '恭喜你，操作成功',
              type: 'success'
    ...
    deletePhysics: function() {
      if (this.currentSelected.length === 0) {
        ...
        deleteDs_dsconfig(data).then(res => {
          if (res.Success) {
            this.$message({
              message: '恭喜你，操作成功',
              type: 'success'
