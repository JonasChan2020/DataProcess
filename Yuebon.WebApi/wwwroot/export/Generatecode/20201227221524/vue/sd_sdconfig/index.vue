  ...
  <div class="app-container">
    ...
    <el-card>
      ...
      >
        <el-table-column type="selection" width="30" />
                <el-table-column prop="Dsconfig" label="目标库配置信息" sortable="custom" width="120" />
    ...
    >
      <el-form ref="editFrom" :model="editFrom" :rules="rules">
                <el-form-item label="目标库配置信息" :label-width="formLabelWidth" prop="Dsconfig">
          <el-input v-model="editFrom.Dsconfig" placeholder="请输入目标库配置信息" autocomplete="off" clearable />
        </el-form-item>
...
import { getSd_sdconfigListWithPager, getSd_sdconfigDetail,
  saveSd_sdconfig, setSd_sdconfigEnable, deleteSoftSd_sdconfig,
  deleteSd_sdconfig } from '@/api/sd_sdconfig/sd_sdconfig'
...
export default {
  ...
  methods: {
    ...
    loadTableData: function() {
      ...
      getSd_sdconfigListWithPager(seachdata).then(res => {
    ...
    bindEditInfo: function() {
      getSd_sdconfigDetail(this.currentId).then(res => {
               this.editFrom.Dsconfig = res.ResData.Dsconfig
    ...
    saveEditForm() {
      this.$refs['editFrom'].validate((valid) => {
        if (valid) {
          const data = {
                   'Dsconfig':this.editFrom.Dsconfig,
    ...
    setEnable: function(val) {
      if (this.currentSelected.length === 0) {
        ...
        setSd_sdconfigEnable(data).then(res => {
          if (res.Success) {
            this.$message({
              message: '恭喜你，操作成功',
              type: 'success'
    ...
    deleteSoft: function(val) {
      if (this.currentSelected.length === 0) {
        ...
        deleteSoftSd_sdconfig(data).then(res => {
          if (res.Success) {
            this.$message({
              message: '恭喜你，操作成功',
              type: 'success'
    ...
    deletePhysics: function() {
      if (this.currentSelected.length === 0) {
        ...
        deleteSd_sdconfig(data).then(res => {
          if (res.Success) {
            this.$message({
              message: '恭喜你，操作成功',
              type: 'success'
